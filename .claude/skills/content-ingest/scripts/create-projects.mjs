 ...
 * project's Webflow collection + option IDs, and adapt the CATEGORY_IDS /
 * COUNTRY_IDS maps to your project's taxonomy. See `config.example.json` for
...
const PROJECTS_COLLECTION = 'REPLACE_ME_PROJECTS_COLLECTION_ID'

// Adapt these maps to your project's category + country taxonomy.
const CATEGORY_IDS = {
  'Category Name': 'REPLACE_ME_CATEGORY_ITEM_ID'
}
const COUNTRY_IDS = {
  'Country Name': 'REPLACE_ME_COUNTRY_ITEM_ID'
}
