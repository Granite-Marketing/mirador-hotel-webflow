...
// Per-project configuration: fill in REPLACE_ME values from your project's
// Webflow collection + option IDs. See `config.example.json` for the canonical
// pattern.
const PRINCIPALS = 'REPLACE_ME_PRINCIPALS_COLLECTION_ID'
const TEAMS = 'REPLACE_ME_TEAMS_COLLECTION_ID'
const LEGAL_PARTNERS = 'REPLACE_ME_LEGAL_PARTNERS_COLLECTION_ID'
const CONSULTANTS = 'REPLACE_ME_CONSULTANTS_COLLECTION_ID'

const TEAM_CATEGORY = {
  'Team Leader': 'REPLACE_ME_OPTION_ID',
  'Team Member': 'REPLACE_ME_OPTION_ID',
  'Administration': 'REPLACE_ME_OPTION_ID'
}
